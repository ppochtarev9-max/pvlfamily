...
SERVER_KEY="~/.ssh/pvl_server_key"
PROJECT_PATH_REMOTE="~/pvl_app"
SERVICE_NAME="pvlfamily"
COMMIT_MESSAGE="${1:-Auto-update: $(date '+%Y-%m-%d %H:%M')}" # Сообщение коммита из аргумента или по умолчанию
...
# Используем ssh с полной спецификацией пути к python и без source

...
def delete_user(user_id: int, db: Session = Depends(get_db)):
    ...
    # Важно: Мы НЕ удаляем транзакции и события. 
    # SQLAlchemy при удалении пользователя просто обрывает связь (так как foreign_key nullable).
    # История сохраняется, но становится "бесхозной".
